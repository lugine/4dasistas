...
**Files:** `index.html` (Fall signup form section only) — updating club descriptions, deadline, STANDBY option, and club-policy info to match Lujane's full WhatsApp announcement text.
